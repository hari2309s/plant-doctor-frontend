                ...
                <div className="page-container max-w-5xl mx-auto px-6">
                    ...
                    >
                        ...
                        <div className="grid md:grid-cols-2 gap-6 mb-12">
                            {[
                                {
                                    icon: <HiChip className="h-8 w-8 text-green-600" />,
                                ...
                                {
                                    icon: <HiLightBulb className="h-8 w-8 text-green-600" />,
                                ...
                                {
                                    icon: <HiGlobe className="h-8 w-8 text-green-600" />,
                                ...
                                {
                                    icon: <HiHeart className="h-8 w-8 text-green-600" />,
                        ...
                        <div className="text-center mb-12">
                            ...
                            <Link href="/diagnose">
                                <Button size="lg" className="bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-6 rounded-md">
                                    Get Started Now
                                </Button>
                            </Link>
                        </div>
