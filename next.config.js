...
const nextConfig = {
  ...
  images: {
    domains: ["plant-doctor-rvhe57w4xz08.deno.dev"],
    remotePatterns: [
      {
        protocol: "https",
        hostname: "plant-doctor-rvhe57w4xz08.deno.dev",
        port: "",
        pathname: "/**",
      },
    ],
  ...
  env: {
    ...
    PLANT_DOCTER_API_BASE_URL: "https://plant-doctor-rvhe57w4xz08.deno.dev"
  },
  webpack(config) {
