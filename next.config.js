...
const nextConfig = {
  ...
  images: {
    domains: ["plant-doctor-k6kjgzs4fmt1.deno.dev"],
    remotePatterns: [
      {
        protocol: "https",
        hostname: "plant-doctor-k6kjgzs4fmt1.deno.dev",
        port: "",
        pathname: "/**",
      },
    ],
  ...
  env: {
    ...
    PLANT_DOCTER_API_BASE_URL: "https://plant-doctor-k6kjgzs4fmt1.deno.dev"
  },
  webpack(config) {
