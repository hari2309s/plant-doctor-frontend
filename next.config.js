...
const nextConfig = {
  ...
  images: {
    domains: ["plant-doctor-0rtmwqzk4r02.deno.dev"],
    remotePatterns: [
      {
        protocol: "https",
        hostname: "plant-doctor-0rtmwqzk4r02.deno.dev",
        port: "",
        pathname: "/**",
      },
    ],
  ...
  env: {
    ...
    PLANT_DOCTER_API_BASE_URL: "https://plant-doctor-0rtmwqzk4r02.deno.dev"
  },
  webpack(config) {
