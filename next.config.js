...
const nextConfig = {
  ...
  images: {
    domains: ["plant-doctor-pgqtr645b85r.deno.dev"],
    remotePatterns: [
      {
        protocol: "https",
        hostname: "plant-doctor-pgqtr645b85r.deno.dev",
        port: "",
        pathname: "/**",
      },
    ],
  ...
  env: {
    ...
    PLANT_DOCTER_API_BASE_URL: "https://plant-doctor-pgqtr645b85r.deno.dev"
  },
  webpack(config) {
