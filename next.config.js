...
const nextConfig = {
  ...
  images: {
    domains: ["plant-doctor-5vcveqm2b911.deno.dev"],
    remotePatterns: [
      {
        protocol: "https",
        hostname: "plant-doctor-5vcveqm2b911.deno.dev",
        port: "",
        pathname: "/**",
      },
    ],
  ...
  env: {
    ...
    PLANT_DOCTER_API_BASE_URL: "https://plant-doctor-5vcveqm2b911.deno.dev"
  },
  webpack(config) {
