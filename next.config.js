...
const nextConfig = {
  ...
  images: {
    domains: ["plant-doctor-c413cba7v5q8.deno.dev"],
    remotePatterns: [
      {
        protocol: "https",
        hostname: "plant-doctor-c413cba7v5q8.deno.dev",
        port: "",
        pathname: "/**",
      },
    ],
  ...
  env: {
    ...
    PLANT_DOCTER_API_BASE_URL: "https://plant-doctor-c413cba7v5q8.deno.dev"
  },
  webpack(config) {
