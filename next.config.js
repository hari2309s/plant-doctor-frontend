...
const nextConfig = {
  ...
  images: {
    domains: ["plant-doctor-94rdvmsfqd2b.deno.dev"],
    remotePatterns: [
      {
        protocol: "https",
        hostname: "plant-doctor-94rdvmsfqd2b.deno.dev",
        port: "",
        pathname: "/**",
      },
    ],
  ...
  env: {
    ...
    PLANT_DOCTER_API_BASE_URL: "https://plant-doctor-94rdvmsfqd2b.deno.dev"
  },
  webpack(config) {
