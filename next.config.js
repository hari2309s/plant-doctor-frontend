...
const nextConfig = {
  ...
  images: {
    domains: ["plant-doctor-2neqgyy367t4.deno.dev"],
    remotePatterns: [
      {
        protocol: "https",
        hostname: "plant-doctor-2neqgyy367t4.deno.dev",
        port: "",
        pathname: "/**",
      },
    ],
  ...
  env: {
    ...
    PLANT_DOCTER_API_BASE_URL: "https://plant-doctor-2neqgyy367t4.deno.dev"
  },
  webpack(config) {
