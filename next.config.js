...
const nextConfig = {
  ...
  images: {
    domains: ["plant-doctor-76hdm8jnmyar.deno.dev"],
    remotePatterns: [
      {
        protocol: "https",
        hostname: "plant-doctor-76hdm8jnmyar.deno.dev",
        port: "",
        pathname: "/**",
      },
    ],
  ...
  env: {
    ...
    PLANT_DOCTER_API_BASE_URL: "https://plant-doctor-76hdm8jnmyar.deno.dev"
  },
  webpack(config) {
