...
const nextConfig = {
  ...
  images: {
    domains: ["plant-doctor-rcwn15g1bkza.deno.dev"],
    remotePatterns: [
      {
        protocol: "https",
        hostname: "plant-doctor-rcwn15g1bkza.deno.dev",
        port: "",
        pathname: "/**",
      },
    ],
  ...
  env: {
    ...
    PLANT_DOCTER_API_BASE_URL: "https://plant-doctor-rcwn15g1bkza.deno.dev"
  },
  webpack(config) {
