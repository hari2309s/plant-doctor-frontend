...
const nextConfig = {
  ...
  images: {
    domains: ["plant-doctor-2yvmhj720j4j.deno.dev"],
    remotePatterns: [
      {
        protocol: "https",
        hostname: "plant-doctor-2yvmhj720j4j.deno.dev",
        port: "",
        pathname: "/**",
      },
    ],
  ...
  env: {
    ...
    PLANT_DOCTER_API_BASE_URL: "https://plant-doctor-2yvmhj720j4j.deno.dev"
  },
  webpack(config) {
