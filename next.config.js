...
const nextConfig = {
  ...
  images: {
    domains: ["plant-doctor-m58r22yaq6nh.deno.dev"],
    remotePatterns: [
      {
        protocol: "https",
        hostname: "plant-doctor-m58r22yaq6nh.deno.dev",
        port: "",
        pathname: "/**",
      },
    ],
  ...
  env: {
    ...
    PLANT_DOCTER_API_BASE_URL: "https://plant-doctor-m58r22yaq6nh.deno.dev"
  },
  webpack(config) {
